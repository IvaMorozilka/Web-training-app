...
import {FastForward, FastRewind, Pause, PlayArrow, SkipNext, VolumeDown, VolumeUp} from "@mui/icons-material";
    ...
    return (
        <Box sx={{
            ...
            <Box sx={{
                ...
                <FastRewind fontSize="large" style={{color: theme.palette.secondary.main}}/>
                <Pause fontSize="large" style={{color: theme.palette.secondary.main}}/>
                <FastForward fontSize="large" style={{color: theme.palette.secondary.main}}/>
            </Box>
            {/*Bottom*/}
            <Box mx='25px'>
                <Box>
